...
import video from "../../assets/Video/Beautiful Establishing Shots Compilation in Movies [HD] by X2.mp4";
export default function Services() {
  return (
    <div className="Services">
      <div className="subservies">
      ...
      <div className="subservies">
        <div className="content">
          ...
          <p>
            ...
            corrupti deleniti laudantium ab odio quidem molestias dolorum omnis.
            Iusto, ad. Sunt quo, dolorum et deserunt quos iure dolores
            reiciendis explicabo asperiores sapiente aperiam?
          </p>
        </div>
